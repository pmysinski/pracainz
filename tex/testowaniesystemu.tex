...
\end{lstlisting}
Po wykonaniu tego polecenia zostanie utworzona baza danych. Takie same dane należy teraz wpisać do pliku konfiguracyjnego programu czyli \emph{DBRaportLatex.bat} aby program mógł się połączyć z tą bazą:
\begin{lstlisting}
